...
5. **Import Dashboard:** 
Click `New Dashboard` and then import JSON file to create an existing dashboard. For this demo we are using SigNoz [Hostmetrics JSON](https://github.com/ezeslucky/monitrix.git/dashboards/blob/main/hostmetrics/hostmetrics.json) Dashboard. For more information, refer to [**Hostmetrics** documentation](https://signoz.io/docs/userguide/hostmetrics/#setup).
