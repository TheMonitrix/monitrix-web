...
If you want to [get started](https://signoz.io/docs/userguide/hostmetrics/) quickly with PostgreSQL monitoring, you can [load](https://github.com/ezeslucky/monitrix.git/dashboards/tree/main/postgresql) this JSON  dashboard config in the SigNoz dashboard UI.
