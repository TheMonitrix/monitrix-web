...
<a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.13.0" rel="noopener noreferrer nofollow" target="_blank" >Latest Release v0.13.0</a>.
...
We are working on creating more compact views in our logs tab so that it’s easier for our users to analyze logs quickly. We are currently iterating on solutions based on user feedback. Feel free to open up a <a href = "https://github.com/ezeslucky/monitrix.git/signoz/discussions" rel="noopener noreferrer nofollow" target="_blank" > GitHub discussion</a> if you have ideas or feedback to share.
...
If you have any ideas on dashboards that we should enable out of the box, feel free to comment on this <a href = "https://github.com/ezeslucky/monitrix.git/signoz/issues/1801" rel="noopener noreferrer nofollow" target="_blank" > GitHub issue </a>.

## Featured Issue

**[Default dashboards for applications based on language/framework used](https://github.com/ezeslucky/monitrix.git/signoz/issues/1964)**
...
If you have some requirements based on application frameworks you use in your stack, feel free to comment on this <a href = "https://github.com/ezeslucky/monitrix.git/signoz/issues/1964" rel="noopener noreferrer nofollow" target="_blank" > GitHub issue </a>.
