...
keywords: [opentelemetry,ruby,opentelemetry ruby,ruby on rails,distributed tracing,distributed tracing tool,apm tools,application performance monitoring]
---
...
After following above steps, you can now monitor your Rails app with SigNoz. You can use this [sample Ruby on Rails app](https://github.com/ezeslucky/monitrix.git/sample-rails-app) that was instrumented using above steps to see how the collected data is visualized with SigNoz dashboard.
...
<YouTube id="sNMIyQh7Oyo" mute={false} />
