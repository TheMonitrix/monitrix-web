...
Latest release - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.33.0" rel="noopener noreferrer nofollow" target="_blank" >v0.33.0</a>

Previous Releases - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.32.1" rel="noopener noreferrer nofollow" target="_blank" >v0.32.1</a>, <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.32.0" rel="noopener noreferrer nofollow" target="_blank" >v0.32.0</a>, <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.31.1" rel="noopener noreferrer nofollow" target="_blank" >v0.31.1</a>
...
We hope this feature improves your logs experience with SigNoz. We would love some feedback on it on how to improve it further. You can create a <a href = "https://github.com/ezeslucky/monitrix.git/signoz/issues" rel="noopener noreferrer nofollow" target="_blank" >GitHub issue</a> with your feedback.
