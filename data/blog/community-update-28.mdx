...
Latest release - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.28.0" rel="noopener noreferrer nofollow" target="_blank" >v0.28.0</a>

Earlier Releases - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.27.0" rel="noopener noreferrer nofollow" target="_blank" >v0.27.0</a>, <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.26.1" rel="noopener noreferrer nofollow" target="_blank" >v0.26.1</a>, <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.26.0" rel="noopener noreferrer nofollow" target="_blank" >v0.26.0</a>
...
- With the latest release, you can have the same attributes with multiple data types. For example, `status` can exist as a string with values `ok/fail`, etc., and `status` can exist as int with values `200/202`, etc. (<a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3275" rel="noopener noreferrer nofollow" target="_blank" >Related PR</a>)

- Previously, the docker container logs didn’t have `container_name`   by default, because of which it was difficult to filter out logs by a container name. We have added Logspout as the default docker logs collector. Now, the container name is added to the metadata of logs. (<a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3225" rel="noopener noreferrer nofollow" target="_blank" >Related PR</a>)

- Check nearby lines of logs with in-context logs. (<a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3190" rel="noopener noreferrer nofollow" target="_blank" >Related PR</a>)
...
- Live view of Logs in Explorer pages. (<a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3170" rel="noopener noreferrer nofollow" target="_blank" >Related PR</a>)
