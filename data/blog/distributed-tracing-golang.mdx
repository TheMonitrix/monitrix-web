...
keywords: [distributed tracing,golang,tracing golang,distributed tracing golang,opentelemetry,opentelemetry golang,traces,open source]
---
...
- MySQL 8
  ...
  - If your MySQL is configured with a password, update it here:
    [https://github.com/ezeslucky/monitrix.git/distributed-tracing-golang-sample/blob/master/.env](https://github.com/ezeslucky/monitrix.git/distributed-tracing-golang-sample/blob/master/.env)
...
We will be using a sample Golang app at this <a href = "https://github.com/ezeslucky/monitrix.git/distributed-tracing-golang-sample" rel="noopener noreferrer nofollow" target="_blank">GitHub repo</a>.

```jsx
git clone https://github.com/ezeslucky/monitrix.git/distributed-tracing-golang-sample.git
...
<YouTube id="pDl6N62ZYQI" mute={false} />
