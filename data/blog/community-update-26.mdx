...
Latest release - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.22.0" rel="noopener noreferrer nofollow" target="_blank" >v0.22.0</a>

Earlier Releases - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.21.0" rel="noopener noreferrer nofollow" target="_blank" >v0.21.0</a>
...
We have also introduced a feature to configure noisy top-level operations. You can find more details about it in this <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/2978" rel="noopener noreferrer nofollow" target="_blank" >PR</a>.
