...
**[Better quick start experience](https://github.com/ezeslucky/monitrix.git/signoz/issues/649)**
...
We would love to hear your ideas on this, and if you know best practices to get applications installed with docker images, feel free to share on this [GitHub issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/649).
...
You can check out the WIP version [here](https://github.com/ezeslucky/monitrix.git/troubleshoot).

Please feel free to share any inputs/feedback you have on this. If you know some best practices around this, please mention that too in this [GitHub discussions](https://github.com/ezeslucky/monitrix.git/signoz/discussions/680).
...
- [fix: local dev setup](https://github.com/ezeslucky/monitrix.git/signoz/pull/599) by [Kartik Verma](https://github.com/krtkvrm)

- [ci: removing the timeout from the rollout command](https://github.com/ezeslucky/monitrix.git/signoz/pull/605) by [Yoni Bettan](https://github.com/ybettan)
