...
You can find the application code instrumented with OpenTelemetry and ready to be monitored with SigNoz [here](https://github.com/ezeslucky/monitrix.git/mevn-opentelemetry-example). Get it to your local by cloning the GitHub repo:

```bash
git clone <https://github.com/ezeslucky/monitrix.git/mevn-opentelemetry-example.git>
...
{/* Here’s a snapshot from the GitHub repo. You can find the file [here](https://github.com/ezeslucky/monitrix.git/mevn-opentelemetry-example/blob/main/signoz/deploy/docker/otel-collector-config.yaml).
