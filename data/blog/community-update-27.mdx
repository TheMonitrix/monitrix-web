...
Latest release - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.24.0" rel="noopener noreferrer nofollow" target="_blank" >v0.24.0</a>

Earlier Releases - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.23.1" rel="noopener noreferrer nofollow" target="_blank" >v0.23.1</a>, <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.23.0" rel="noopener noreferrer nofollow" target="_blank" >v0.23.0</a>
...
You can read more about it from the <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3110" rel="noopener noreferrer nofollow" target="_blank" >PR</a>.

### Improved User Experience

We also shipped other important upgrades to improve the user experience. Some noteworthy PRs are:

- <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3100" rel="noopener noreferrer nofollow" target="_blank" >Ability to drag columns to change position in list view of explorer pages</a>.

- <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/2964" rel="noopener noreferrer nofollow" target="_blank" >Table view for explorer pages</a>.

- <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/3146" rel="noopener noreferrer nofollow" target="_blank" >Goto Top button on Logs List view</a>.
