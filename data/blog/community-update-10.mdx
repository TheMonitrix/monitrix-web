...
[v0.7.1](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.7.1)
...
[Enable S3 storage for ClickHouse](https://github.com/ezeslucky/monitrix.git/signoz/issues/812)
...
If you know about other solutions for data retention or have experience working with S3, feel free to comment on this [Github issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/812).
...
[feat: new trace detail page styling changes](https://github.com/ezeslucky/monitrix.git/signoz/pull/767) by [Pranshu Chittora](https://github.com/pranshuchittora)

[Removing Feedback FAB](https://github.com/ezeslucky/monitrix.git/signoz/pull/753) by [Udasi Tharani](https://github.com/udasitharani)

[Fix: update documentation for query-service](https://github.com/ezeslucky/monitrix.git/signoz/pull/762) by [Axay Sagathiya](https://github.com/axaysagathiya)

[fix(FE) Removed refresh time filter from trace-detail page](https://github.com/ezeslucky/monitrix.git/signoz/pull/581) by [Siddhant Parekh](https://github.com/siddhantparekh)

[fix: Dashboard page does not call API on clicking on apply button](https://github.com/ezeslucky/monitrix.git/signoz/pull/677) by [Sonia Manoubi](https://github.com/SoniaisMad)

[fix: added support for custom alertmanager URL](https://github.com/ezeslucky/monitrix.git/signoz/pull/699) by [Patrik](https://github.com/Tazer)

[Gitpodify Signoz](https://github.com/ezeslucky/monitrix.git/signoz/pull/634) by [Siddhant Khare](https://github.com/Siddhant-K-code)

[fix: remove table `default.signoz_spans` from the codebase](https://github.com/ezeslucky/monitrix.git/signoz/pull/656) by [Mustaque Ahmed](https://github.com/amustaque97)

[Fixed svg color mismatch in light mode and dark mode](https://github.com/ezeslucky/monitrix.git/signoz/pull/504) by ****[Devesh Kumar](https://github.com/Devesh21700Kumar)

[closes #569: critical css using critters](https://github.com/ezeslucky/monitrix.git/signoz/pull/570) by [Anik Das](https://github.com/sadn1ck) --> */}
...
Thank you for taking out the time to read this issue :) If you have any feedback or want any changes with the format, please create an [issue](https://github.com/ezeslucky/monitrix.git/signoz/issues).
