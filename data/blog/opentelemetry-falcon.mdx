...
We will be using the Falcon app at this [Github repo](https://github.com/ezeslucky/monitrix.git/python-falcon-template). All the required OpenTelemetry packages are contained within the `base.txt` file under `requirements` folder in this sample app. 


```bash
git clone https://github.com/ezeslucky/monitrix.git/python-falcon-template.git
