...
Latest Release link: [v0.3.6](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.3.6)
...
Digital Ocean is a very popular cloud infrastructure provider used by a lot of devs. We want our users to have a simple single click install experience for SigNoz on Digital Ocean. We will appreciate if any of you wants to share any inputs on the [GitHub issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/284).
...
**[SigNoz Performance Benchmarking](https://github.com/ezeslucky/monitrix.git/signoz/discussions/218)**
