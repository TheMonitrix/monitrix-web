...
keywords: [docker,docker stats,docker containers,docker monitoring,docker container monitoring,container monitoring,resource metrics,resource utilization]
---
...
<Admonition>
These are in-built features of Docker.
