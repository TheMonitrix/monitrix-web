...
**[v0.7.4](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.7.4)**<br></br>
**[v0.7.5](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.7.5)**
...
Relevant PR:<br></br>
[feat(query-service): Add cold storage support in getTTL API](https://github.com/ezeslucky/monitrix.git/signoz/pull/922)
...
[Deploying SigNoz in large-scale production environments](https://github.com/ezeslucky/monitrix.git/signoz/issues/940)
...
Feel free to comment on this [GitHub issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/940).
...
[feat: query spans_table to fetch trace details](https://github.com/ezeslucky/monitrix.git/signoz/pull/838)
...
[![SigNoz repo](/img/blog/common/signoz_github.webp)](https://github.com/ezeslucky/monitrix.git/signoz)
