...
[Release v0.5.1](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.5.1)
...
[Package SigNoz as a Single binary](https://github.com/ezeslucky/monitrix.git/signoz/issues/392)<br></br>
...
We have also noticed trying to install the docker script as one of the reasons for users dropping out. Let us know what you think; we would love to hear suggestions on how to make trying out SigNoz easier. Comment on this [issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/392), or use our [GitHub discussions](https://github.com/ezeslucky/monitrix.git/signoz/discussions).
...
We are excited to inform you that we have expanded our team with [Vishal Sharma](https://www.linkedin.com/in/makeavish/) joining as a backend engineer. He is passionate about deep tech and has great plans on how to make SigNoz better and he has already made his [first PR](https://github.com/ezeslucky/monitrix.git/signoz/pull/429)!
...
- [fix(routes): update key and redirect home to application](https://github.com/ezeslucky/monitrix.git/signoz/pull/342) by [Yash Joshi](https://github.com/jyash97)

- [Update webpack config to typescript](https://github.com/ezeslucky/monitrix.git/signoz/pull/334) by [Estee Tey](https://github.com/lyqht)

- Improve ESLint Rules [#409](https://github.com/ezeslucky/monitrix.git/signoz/issues/409) & [#426](https://github.com/ezeslucky/monitrix.git/signoz/pull/426) by [Rishit Pandey](https://github.com/genzyy)

- Bug(FE): Remove time filter from settings page [#374](https://github.com/ezeslucky/monitrix.git/signoz/issues/374) & [#385](https://github.com/ezeslucky/monitrix.git/signoz/pull/385) by [Mohmn](https://github.com/Mohmn)
