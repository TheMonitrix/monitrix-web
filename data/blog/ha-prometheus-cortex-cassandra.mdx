...
keywords: [Prometheus,cassandra,cortex,Application Monitoring]
---
...
A [hand-over process](https://github.com/cortexproject/cortex/blob/master/docs/architecture.md) manages the state when ingesters are added, removed or replaced.
