...
LINK - [Release v0.4.0](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.4.0)
...
LINK - [Release v0.4.1](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.4.1)
...
If you have worked with anomaly detection frameworks and libraries, we would love to hear your thoughts on [this](https://github.com/ezeslucky/monitrix.git/signoz/issues/295).
...
As a open-source project, we are excited to [take part](https://signoz.io/blog/hacktoberfest/) in Hacktoberfest 🎉 Find some [good first issues](https://github.com/ezeslucky/monitrix.git/signoz/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22) to submit PRs. Get hacking now!
