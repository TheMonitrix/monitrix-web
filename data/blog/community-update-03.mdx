...
This month, we are excited to announce that our latest release had contributions from 10 awesome contributors. Release link: [v0.3.3](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.3.3)
...
[Link to issue](https://github.com/ezeslucky/monitrix.git/signoz/pull/249)
...
To make our GitHub repo more accessible, we raised requests for getting our [readme.md](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/README.md) translated to different languages. [Tony Qu](https://github.com/tonyqus), a 15+ year .NET veteran, helped translate our [Readme](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/README.zh-cn.md) to Chinese, and we couldn't be happier. 🤓
...
As we mentioned earlier, users requested to visualize 4xx as errors and be highlighted in the SigNoz dashboard. Currently, we have solved it by enabling regex operations on tags. However, we would love to have your inputs on how to visualize it better. Any UI/UX suggestion is welcomed on the [issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/222).

### Readme.md translations

We still have many languages to cover for our readme.md translation. If any of you can help us with [German](https://github.com/ezeslucky/monitrix.git/signoz/issues/240) or [Portugese](https://github.com/ezeslucky/monitrix.git/signoz/issues/238) translations, that would be great.

### Cypress Framework for E2E testing

Cypress is a Javascript-based end-to-end testing framework that provides users with a fast and reliable test framework. We are looking forward to implementing it as our front-end testing framework. If you have any thoughts around it, please consider commenting on the [issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/226).
...
We also wanted to express our gratitude to [Lalit Kale](https://www.linkedin.com/in/lalitkale/) and [Rameshwar Shelge](https://www.linkedin.com/in/rameshwarshelge/) for giving active inputs around [testing](https://github.com/ezeslucky/monitrix.git/signoz/discussions/208) and strategizing [performance benchmarks for SigNoz](https://github.com/ezeslucky/monitrix.git/signoz/discussions/218).
