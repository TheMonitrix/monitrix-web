...
- Langchain App: If you just want to play around to understand SigNoz's capabilities, here’s a [sample Langchain application](https://github.com/ezeslucky/monitrix.git/langchain-sample-app).
...
[JSON for Langchain App Performance Dashboard](https://github.com/ezeslucky/monitrix.git/dashboards/blob/main/llm-observability/sample-chatpdf-performance-metrics.json)

[JSON for Langchain App Cost Dashboard](https://github.com/ezeslucky/monitrix.git/dashboards/blob/main/llm-observability/sample-chatpdf-cost-dashboard.json)
