...
Last month, we had two major releases: [v0.3.1](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.3.1) and [v0.3.2](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.3.2).
...
If you have any views on the above, would love it if you can add a comment to the [issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/193).
...
Thank you for taking out the time to read our second issue :) If you have any feedback or want any changes with the format, create an issue [here](https://github.com/ezeslucky/monitrix.git/signoz/issues).
