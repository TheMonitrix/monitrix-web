...
[SigNoz](https://signoz.io/product-comparison/signoz-vs-grafana/) can be a great Grafana alternative. SigNoz is also open-source, just like Grafana. So, if you want to self-host SigNoz, clone the <a href = "https://github.com/ezeslucky/monitrix.git/signoz/" rel="noopener noreferrer nofollow" target="_blank" >GitHub repo</a> to get started.
