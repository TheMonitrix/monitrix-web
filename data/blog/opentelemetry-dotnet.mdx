...
keywords: [opentelemetry,dotnet,opentelemetry dotnet,.net application,opentelemetry .net,metrics,traces,logs,signoz,apm tools,application performance monitoring]
---
...
You can find the code sample used in the tutorial at this [GitHub repo](https://github.com/ezeslucky/monitrix.git/sample-dotnet-otel).
...
<YouTube id="9SwL5kMDcvY" mute={false} />
