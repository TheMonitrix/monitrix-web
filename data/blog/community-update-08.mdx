...
Latest Release: <a href = "https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.5.4" rel="noopener noreferrer nofollow" target="_blank" >Release v0.5.4</a>

### Helm Charts for ClickHouse Setup

Related PR - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/479" rel="noopener noreferrer nofollow" target="_blank" >https://github.com/ezeslucky/monitrix.git/signoz/pull/479</a>
...
Related PR - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/537" rel="noopener noreferrer nofollow" target="_blank" >https://github.com/ezeslucky/monitrix.git/signoz/pull/537</a>

Hetzner cloud is a popular hosting service provider from Germany. With this [PR](https://github.com/ezeslucky/monitrix.git/signoz/pull/537), Hetzner users can deploy SigNoz easily using Helm charts.

### Mac M1 support released for ClickHouse setup

Related PR - <a href = "https://github.com/ezeslucky/monitrix.git/signoz/pull/429" rel="noopener noreferrer nofollow" target="_blank" >https://github.com/ezeslucky/monitrix.git/signoz/pull/429</a>
...
- <a href = "https://github.com/ezeslucky/monitrix.git/signoz/issues/530" rel="noopener noreferrer nofollow" target="_blank" >Tracing Serverless Architecture</a>
...
We would love to hear your ideas on this, and if you have used distributed tracing for your serverless functions, feel free to share on this [GitHub issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/530).
...
- [Allow empty input values in settings retention page](https://github.com/ezeslucky/monitrix.git/signoz/pull/459) and three others by [Aryan Shridhar](https://github.com/aryanshridhar)

- [fix: product feedback button](https://github.com/ezeslucky/monitrix.git/signoz/pull/458) by [Anurag Gupta](https://github.com/Anurag5086)

- [build(kubernetes): Support hcloud CSI (Hetzner)](https://github.com/ezeslucky/monitrix.git/signoz/pull/537) by [Hendy Irawan](https://github.com/ceefour)
