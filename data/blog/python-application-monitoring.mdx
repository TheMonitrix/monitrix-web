...
keywords: [python application monitoring,opentelemetry,opentelemetry python,python app,python,distributed tracing]
---
...
We have set up a <a href="https://github.com/ezeslucky/monitrix.git/sample-flask-app" rel="noopener noreferrer nofollow" target="_blank" >sample ToDo Python app</a> based on Flask web framework, which uses MongoDB as a database to demonstrate how SigNoz works. We will divide the tutorial into two parts:
...
<YouTube id="oZkFfMN57yI" mute={false} />
