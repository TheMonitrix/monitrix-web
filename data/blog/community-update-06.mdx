...
[Release v0.4.3](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.4.3)

[Release v0.4.2](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.4.2)
...
**[Handling specific use-cases with OpenTelemetry auto-instrumentation](https://github.com/ezeslucky/monitrix.git/signoz/issues/345)**
...
- [chore(jest): setup jest for frontend #331](https://github.com/ezeslucky/monitrix.git/signoz/pull/331) by [Bhavin Ag](https://github.com/ezeslucky/monitrix.git/signoz/pull/331)

- [Feat(FE): Add Sonar analysis to build pipeline #324](https://github.com/ezeslucky/monitrix.git/signoz/pull/324) by [Adam Szatyin](https://github.com/szatyinadam)

- [Added GET/SET endpoint for setting ttl for clickhouse #304](https://github.com/ezeslucky/monitrix.git/signoz/pull/304) by [Yash Sharma](https://github.com/yashrsharma44)

- [refactor: dashboard route generation #340](https://github.com/ezeslucky/monitrix.git/signoz/pull/340) by [Pranay Kumar](https://github.com/pranayrauthu)
