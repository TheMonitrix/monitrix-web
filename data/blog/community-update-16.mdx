...
[Latest Release v0.11.0](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.11.0)
...
- You can now search by service name on the services list page([#1520](https://github.com/ezeslucky/monitrix.git/signoz/pull/1520))
- Support for legend in the query builder formulae([#1530](https://github.com/ezeslucky/monitrix.git/signoz/pull/1530))
...
[Horizontal scaling of OpenTelemetry Collector and ClickHouse](https://github.com/ezeslucky/monitrix.git/signoz/issues/1543)
...
If you have any ideas or context about scaling products to handle huge datasets, feel free to share your experience on this [GitHub issue](https://github.com/ezeslucky/monitrix.git/signoz/issues/1543).
