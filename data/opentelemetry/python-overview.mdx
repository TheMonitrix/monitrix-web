...
<head>
  <link rel="canonical" href="https://signoz.io/opentelemetry/python-overview/"/>
</head>
...
- Sample Repo for the project that we will build - [OpenTelemetry Python Example](https://github.com/ezeslucky/monitrix.git/opentelemetry-python-example)
