...
keywords: [opentelemetry,opentelemetry java,java instrumentation,java auto-instrumentation,signoz]
---

<head>
  <link rel="canonical" href="https://signoz.io/opentelemetry/java-agent/"/>
</head>
