...
<link rel="canonical" href="https://signoz.io/opentelemetry/setting-up-flask-application/"/>
...
The code samples for this tutorial series are present at this [GitHub repo](https://github.com/ezeslucky/monitrix.git/opentelemetry-python-example). You can follow the series by cloning the repo and running the application from the respective lesson directories.

```bash
git clone https://github.com/ezeslucky/monitrix.git/opentelemetry-python-example.git
```
