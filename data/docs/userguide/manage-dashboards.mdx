...
We have shared some commonly used dashboard JSON files [here](https://github.com/ezeslucky/monitrix.git/dashboards). You can import them directly to create dashboards in SigNoz.
