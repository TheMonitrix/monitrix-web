...
of the [`values.yaml`](https://github.com/ezeslucky/monitrix.git/charts/blob/main/charts/k8s-infra/values.yaml) file:
...
override default settings of the [`values.yaml`](https://github.com/ezeslucky/monitrix.git/charts/blob/main/charts/k8s-infra/values.yaml) file:
...
modify/create `override-values.yaml` file with the below configuration to customize and override default settings of the [`values.yaml`](https://github.com/ezeslucky/monitrix.git/charts/blob/main/charts/k8s-infra/values.yaml) file:
