...
By default, SigNoz runs with [this default Otel Collector configuration](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/deploy/docker/otel-collector-config.yaml).
...
- https://github.com/ezeslucky/monitrix.git/charts/blob/main/charts/signoz/README.md#configuration
