...
Use the commands below to sync to the [latest](https://github.com/ezeslucky/monitrix.git/signoz/releases/latest) release.
...
2. Pull the `latest` changes from the [SigNoz GitHub repository](https://github.com/ezeslucky/monitrix.git/signoz):
    ```bash
...
1. Checkout to the [v0.6.2](https://github.com/ezeslucky/monitrix.git/signoz/releases/tag/v0.6.2) tag:
    ```bash
    git checkout v0.6.2
    ```
