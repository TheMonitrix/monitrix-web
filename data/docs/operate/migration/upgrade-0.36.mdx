...
1. To download `migrate-v0.36` binary:
    ...
    ```bash
    wget https://github.com/ezeslucky/monitrix.git/signoz-db-migrations/releases/download/v0.36/migrate-v0.36-linux-amd64
...
For assistance in making these updates, please reach out to us via Intercom support or at aurobindolife888gmail.com
