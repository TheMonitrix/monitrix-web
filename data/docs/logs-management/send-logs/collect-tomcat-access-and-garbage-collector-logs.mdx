...
Update [`docker-compose-minimal.yaml`](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/deploy/docker/docker-compose-minimal.yaml) to mount your log files:
...
Update [`otel-collector-config.yaml`](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/deploy/docker/otel-collector-config.yaml) to include the filelog receiver:
