...
You can also check the sample application at this <a href = "https://github.com/ezeslucky/monitrix.git/sample-nextjs-app/tree/vercel-otel" rel="noopener noreferrer nofollow" target="_blank">GitHub repo</a>.
...
You can also check the sample application at this <a href = "https://github.com/ezeslucky/monitrix.git/sample-nextjs-app" rel="noopener noreferrer nofollow" target="_blank">GitHub repo</a>.
...
Once you're done with this, add your required changes including receivers, exporters in the `config.yml` file which can be generally found [here](https://github.com/ezeslucky/monitrix.git/signoz/blob/main/deploy/docker/otel-collector-config.yaml).
