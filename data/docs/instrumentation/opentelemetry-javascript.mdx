...
3. **Run the application**<br></br>
   ...
   <Admonition>
     ...
     repo](https://github.com/ezeslucky/monitrix.git/sample-nodejs-app/tree/init-tracer-main) which shows the
     implementation.
   </Admonition>
...
- We have included a sample applications at:
  - [Sample React App Github Repo](https://github.com/ezeslucky/monitrix.git/sample-reactjs-app)
  - [Sample NodeJs App Github Repo](https://github.com/ezeslucky/monitrix.git/sample-nodejs-app)
  {/* - [Sample Distributed Tracing NodeJs App Github Repo](https://github.com/ezeslucky/monitrix.git/distributed-tracing-nodejs-sample) */}
