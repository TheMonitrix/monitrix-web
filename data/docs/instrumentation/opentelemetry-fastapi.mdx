...
- We have included a sample FastAPI application with README.md at [Sample FastAPI App Github Repo.](https://github.com/ezeslucky/monitrix.git/sample-fastAPI-app)
