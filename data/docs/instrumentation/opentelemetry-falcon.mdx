...
- We have included a sample Falcon application with README.md at [Sample Falcon App Github Repo.](https://github.com/ezeslucky/monitrix.git/python-falcon-template)
