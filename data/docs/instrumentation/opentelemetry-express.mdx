...
<Admonition>
Refer here for sample [NodeJs express application with MongoDB.](https://github.com/ezeslucky/monitrix.git/sample-nodejs-app/tree/mongodb)
</Admonition>
...
- We have included a sample applications at: [Sample NodeJs App Github Repo](https://github.com/ezeslucky/monitrix.git/sample-nodejs-app)
