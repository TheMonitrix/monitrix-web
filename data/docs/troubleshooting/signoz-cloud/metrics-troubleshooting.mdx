...
For example, if you're using the **[Kubernetes Pod Metrics - Overall](https://github.com/ezeslucky/monitrix.git/dashboards/blob/main/k8s-infra-metrics/kubernetes-pod-metrics-overall.json)** dashboard, you can select $node_name variable as **ALL** to see the data as shown in below image.
