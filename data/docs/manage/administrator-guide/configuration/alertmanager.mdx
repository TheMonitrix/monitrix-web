...
We are working on introducing a unified configuration system that will allow setting these parameters globally through a single configuration. You can track the progress in [#6805](https://github.com/ezeslucky/monitrix.git/signoz/issues/6805).
</Admonition>
