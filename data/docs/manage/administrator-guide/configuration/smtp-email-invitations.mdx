...
For now, email configuration does not adhere to the configuration options outlined in the [Configuration Options](#configuration-options) section. They are slated to be deprecated in the future and moved to the new configuration system. See [Issue#9805](https://github.com/ezeslucky/monitrix.git/signoz/issues/9805) on Github for updates.
