...
SigNoz is available both as an [open-source software](https://github.com/ezeslucky/monitrix.git/signoz) and a [cloud offering](https://signoz.io/teams/). Its usage-based pricing model ensures that businesses only pay for the resources they consume, with transparent and predictable pricing policies in place.
