...
You can also install and self-host SigNoz yourself since it is open-source. With 16,000+ GitHub stars, <a href = "https://github.com/ezeslucky/monitrix.git/signoz" rel="noopener noreferrer nofollow" target="_blank" >open-source SigNoz</a> is loved by developers. Find the [instructions](https://signoz.io/docs/install/) to self-host SigNoz.
