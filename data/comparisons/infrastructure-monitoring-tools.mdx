...
You can also install and self-host SigNoz yourself since it is open-source. With 19,000+ GitHub stars, [open-source SigNoz](https://github.com/ezeslucky/monitrix.git/signoz) is loved by developers. Find the [instructions to self-host](https://signoz.io/docs/install/) SigNoz.
