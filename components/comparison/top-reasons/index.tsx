    ...
    return (
      <section className={`container`}>
        <div className={`${styles.reasonsPoints}`}>
          <h3 className={`${styles.reasonsPointTitle} highlight`}>Key Points: Monitrix vs Grafana</h3>
          <h4 className={styles.reasonMainPointTitle}>Why do devs choose Monitrix over Grafana?</h4>
          <p className={styles.reasonMainPointDesc}>
            Monitrix is loved by developers. With over 14+ Github stars, 10+ contributors, and 20+
...
const OpenSourceReason = () => {
  return (
    <div className={`row ${styles.reasonRow} ${styles.reasonElonMusk}`}>
      ...
      <div className={`col col--6 margin-vert--md`}>
        <div className={styles.reasonDetailContainer}>
          <h4 className={styles.reasonTitle}>Monitrix is open source</h4>
          <p className={styles.reasonDesc}>
            ...
            it to be good value for your money. Trust starts with transparency. Monitrix is open
            source, so you can take a look at our code, test it out, and then make an informed
            decision.
          </p>
          <Link href="https://github.com/ezeslucky/monitrix.git/signoz" className="button button--primary">
