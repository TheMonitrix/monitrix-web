...
const BuildForDevelopers = () => {
  const REASONS = [
    ...
    },
    {
      ...
      desc: 'You can self-host Monitrix or use our cloud services, or use both depending on your use-cases.',
      figure: '/img/graphics/homepage/feature-graphic-flexible-deployment.webp',
    },
    {
      title: 'Columnar database',
      desc: 'Monitrix uses ClickHouse (used by likes of Uber & Cloudflare) as datastore - an extremely fast and highly optimized storage for observability data.',
