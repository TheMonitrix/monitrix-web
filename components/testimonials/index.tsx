    ...
    [
      {
        ...
        review: (
          <>
            <p>
              We use OTel with Monitrix to spot redundant database connect calls. For example, we
      ...
      },
      {
        ...
        review: (
          <>
            <p>
              Monitrix is one of the best observability tools you can self-host hands down. And they
      ...
      },
      {
        ...
        review: (
          <>
            <p>We use Monitrix and have been loving it - can definitely handle scale.</p>
          </>
        ),
      ...
      },
      {
        ...
        review: (
          <>
            <p>
              Recentlly moved metrics and logging to Monitrix. Gotta say, absolutely loving the tool.{' '}
            </p>
          </>
        ),
    ...
    [
      {
        ...
        review: (
          <>
            <p>
              But wow, I'm glad I tried Monitrix. Setting up Monitrix was easy—they provide super
      ...
      },
      {
        ...
        review: (
          <>
            <p>Have been deep diving Monitrix. Seems like the new hotness for an "all-in-one". </p>
          </>
        ),
      ...
      },
      {
        ...
        review: (
          <>
            <p>
              Monitoring done. Thanks to Monitrix, I don't have to deal with Grafana, Loki,
        ...
        review: (
          <>
            <p>
              ...
              @ezeslucky: can run it locally (∞GB), has a special tutorial for OpenTelemetry + Rust!
    ...
    [
      {
        ...
        review: (
          <>
            <p>
              Just deployed Monitrix to an EKS cluster.Still can't believe this is free, everything
    ...
    [
      {
        ...
        review: (
          <>
            <p>
              We are using Monitrix at Outplay & our experience has been great. It has 5.4k stars on
              Github.
            </p>
          </>
        ),
      ...
      },
      {
        ...
        review: (
          <>
            <p>
              What's better than #datadog? Open source! I know @ezeslucky what else out there?
              #opensource{' '}
            </p>
          </>
        ),
      ...
      <div className="section-container !mx-auto flex !w-[100vw] flex-col items-center border !border-b-0 border-dashed border-signoz_slate-400 bg-[url('/img/background_blur/Footer_backdrop.png')] bg-[length:auto_100%] bg-[center_top_-45rem] bg-no-repeat py-24 md:!w-[80vw]">
        <div className="mb-16 flex flex-col items-center gap-12 text-center">
          ...
          <span className="max-w-[50vw] text-center text-sm font-normal leading-10 text-signoz_sienna-200 sm:text-2xl">
            ...
            API response times by 35% using Monitrix. <br />
            Both our dev and QA teams use Monitrix actively in dev and production environments to
