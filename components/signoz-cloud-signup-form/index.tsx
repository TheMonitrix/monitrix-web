  ...
  return (
    <>
      <div className={styles.header}>
        <h2> Get started with Monitrix </h2>
        <h4>Try Monitrix free for 30 days with full access to all features</h4>
      ...
      {!isSubmitting && submitFailed ? (
        <div className={styles.errorContainer}>
          ...
          <a className="button button--primary" href="mailto:aurobindolife888gmail.com">
            Contact Support
          </a>
        </div>
      ) : (
