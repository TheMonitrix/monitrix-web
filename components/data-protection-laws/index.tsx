            ...
            {!isInPricingPage ? (
              <ul className="list-['—_'] pl-5 ">
                ...
                <li className="max-w-[100vw] text-sm font-normal leading-9 text-signoz_vanilla-400 sm:w-[35rem] md:max-w-[50vw] md:text-base">
                  &nbsp;You can self-host Monitrix or opt for our managed self-hosted offerings to
              ...
              <div className="mb-10 text-base font-normal leading-9 text-signoz_vanilla-400">
                ...
                to comply with data privacy regulations. You can also host Monitrix in your own cloud.
              </div>
            )}
          </div>
          ...
          {!isInPricingPage ? (
            <div className="mt-[18px] flex flex-col gap-3 sm:flex-row">
              ...
              >
                ...
                >
                  Use Monitrix Cloud <ArrowRight className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
                </Button>
              </TrackingLink>
              <TrackingLink
                href="/docs/install/"
