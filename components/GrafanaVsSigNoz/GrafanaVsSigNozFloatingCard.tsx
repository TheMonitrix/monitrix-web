...
const GrafanaVsSigNozFloatingCard: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      Tired of juggling multiple tools for observability? Monitrix gives you logs, metrics and traces in a single unified platform.  
      </p>
      <div className="flex flex-col gap-2">
        ...
        <Link id="grafana-vs-signoz-try-signoz-button" href="/teams/" className="w-full">
          ...
          >
            Try Monitrix for Free <ArrowRight className="h-3 w-3" />
          </Button>
        </Link>
      </div>
    </div>
