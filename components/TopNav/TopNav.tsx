  ...
  explore: [
    {
      key: 'faqs',
      url: '/faqs/',
      description: 'Frequently asked questions about Monitrix',
      name: 'Product FAQs',
    },
    {
      key: 'migrations',
      url: '/docs/migration/migrate-from-datadog/',
      description: 'Guides for migrating to Monitrix',
      name: 'Migrations',
    },
    {
      key: 'dashboards',
                          ...
                          <div className="flex flex-col gap-y-4">
                            ...
                            <div>
                              <TrackingLink
                                ...
                                clickText="How Brainfish leveraged Monitrix for effective Kubernetes monitoring"
                                clickLocation="Top Navbar"
                                onClick={handleProductDropdownClick}
                              >
                                <Image
                                ...
                                >
                                  How Brainfish leveraged Monitrix for effective Kubernetes monitoring
                                </div>
                              </TrackingLink>
                            </div>
                          </div>
          ...
          <div className="hidden items-center gap-3 lg:flex lg:flex-1 lg:justify-end">
            ...
            {isLoginRoute && (
              <div className="flex items-center gap-2">
                <TrackingLink
                  href="mailto:aurobindolife888@gmail.com"
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-10 mt-[56px] w-full overflow-y-auto bg-signoz_ink-500 px-6 py-24 !pt-[calc(6rem-56px)] sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 ">
            <div className="flex items-center justify-between">
              <TrackingLink
                ...
                onClick={() => setMobileMenuOpen(false)}
              >
                <span className="sr-only">Monitrix</span>
              </TrackingLink>
            </div>
