                ...
                <div className="space-y-6">
                  ...
                  {!results.some(tool => tool.name === 'SigNoz') && (
                    <div className="mt-8 p-4 border border-blue-500 rounded-lg bg-gray-800 bg-opacity-50">
                      <h4 className="text-lg mt-0 font-semibold text-white">Have You Considered Monitrix</h4>
                      <p className="text-gray-300 mt-2">
                        Monitrix offers a cost-effective, open-source alternative with full-stack observability and native OpenTelemetry support. Perfect for teams looking for flexible deployment options and simple pricing.
                      </p>
                      <div className="mt-4 flex flex-col sm:flex-row gap-4">
                        <Button>
                          <a 
