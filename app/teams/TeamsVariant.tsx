        ...
        <div className="flex justify-start">
          <Link href="/" className="-m-1.5 flex items-center gap-2 p-1.5">
            <Image
              ...
              alt="SigNoz Logo"
            />
            <span className="text-[17.111px] font-medium">Monitrix</span>
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="mx-auto w-full max-w-md">
      ...
      <a
        ...
        href="mailto:aurobindolife888gmail.com"
      >
...
const testimonials = [
  {
    quote:
      'With Monitrix in place, I was able to pinpoint why, how, and exactly what was going wrong in no time.',
    author: 'Aurobindo Patra, Full-Stack  Engineer,',
  ...
  },
  {
    ...
    author: 'Aurobindo Patra, Co-founder',
    avatar: '/img/case_study/profile-photos/cedana.webp',
    url: '/case-study/cedana/',
  },
  {
    quote:
      'Monitrix has been a huge help with a smooth experience, prompt and effective technical support by devs.',
    author: 'Subranshu Sekher Panda, Full-Stack Java Engineer',
    avatar: '/img/case_study/profile-photos/mailmodo.webp',
    url: '/case-study/mailmodo/',
  },
  {
    quote:
      "We use Monitrix daily—it's open in more than half my tabs and is vital to our operations.",
    author: 'Samir Kumar Panjha,  Backend Engineer',
    avatar: '/img/case_study/profile-photos/kiwi.webp',
    url: '/case-study/kiwi/',
  },
  {
    quote: 'Monitrix has elevated our software quality and keeps our customers delighted.',
    author: 'Aurobindo Patra, Lead DevOps Engineer',
...
const SignupFormIsolated: React.FC<{
  ...
  return (
    <div className="mx-auto w-full max-w-md">
      <h1 className="mb-1 text-2xl font-medium text-white">Get started with Monitrix</h1>
      <p className="mb-10 text-sm text-signoz_vanilla-100/70">
        Experience Monitrix with 30-day free trial. No credit card required.
      </p>
