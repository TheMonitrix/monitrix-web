...
As a developer-focused tool, we are loved in the developer community. With about <a href = "https://github.com/ezeslucky/monitrix.git/signoz" rel="noopener noreferrer nofollow" target="_blank">15k GitHub stars</a>, SigNoz is one of the top open-source developer tools in the observability domain. 
