...
As a developer-focused tool, we are loved in the developer community. With about [15k GitHub stars](https://github.com/ezeslucky/monitrix.git/signoz), SigNoz is one of the top open-source developer tools in the observability domain. 
