  ...
  return (
    <div className="relative bg-[#0A0A0A]">
        ...
        <div className="relative bg-[#0A0A0A] py-8 sm:py-16">
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-4xl">
              ...
              <p className="mb-6 sm:mb-8 text-base sm:text-lg font-normal text-gray-300 lg:text-xl">
                You can get started immediately with OpenTelemetry by signing up for Monitrix cloud. We have an onboarding module that will help you instrument your application with OpenTelemetry and send data to Monitrix for visualization.
              </p>
              <div>
                <Link href="/teams/">
      ...
      >
        ...
        <p>
          In Monitrix, users can quickly go from application metrics to related logs and traces with data from OpenTelemetry instrumented applications.
        </p>
      </ReasonSection>
