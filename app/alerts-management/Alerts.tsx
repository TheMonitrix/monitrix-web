    ...
    <header className="relative !mx-auto mt-16 !w-[100vw] md:!w-[80vw]">
      ...
      <div className="relative !mx-auto flex !w-[100vw] flex-col items-center border !border-b-0 border-dashed border-signoz_slate-400 px-2 pb-4 pt-12 text-center md:!w-[80vw] md:px-5 md:pt-[8.5rem]">
        ...
        <p className="m-0 p-3 text-lg font-normal leading-8 text-signoz_vanilla-400 sm:p-0">
          Create actionable alerts on metrics, logs, traces and exceptions and get notified in your
          preferred channel.
  ...
  const sections = [
    {
      ...
      desc: [
        'You can create alerts on any kind of telemetry signal - logs, metrics, traces and exceptions. You can create complex queries to get the required metrics that you want to monitor with alerts.',
    ...
    },
    {
      ...
      desc: [
        'In this step, you set the alerts metadata, including severity, name, and description. Set severity level of the alert like ‘warning’, or ‘critical’, set alert name and description. You can also add labels to your alerts. Then finally, set a notification channel to be notified.',
      ],
      logo: '/img/log-management/fast.svg',
