      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-24 pt-20 sm:px-6 sm:pb-32 lg:px-8 lg:pt-32">
        ...
        <section className="container mx-auto mb-10 flex flex-col items-center justify-between lg:flex-row">
          ...
          >
            ...
            <h3 className="mb-8 text-lg font-semibold text-gray-300 lg:text-xl">
              For 20 APM and 50 infra hosts, Monitrix can save up to 80% of your Datadog bill - check
              comparison with{' '}
              <Link
        ...
        <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          ...
          <div className="mb-8">
            <p className="text-lg text-gray-300">
              Monitrix is often referred to as "Open-Source Datadog Alternative" by our users. We
              built Monitrix to address the absence of a great one-stop observability tool in the
              ...
              <br />
              <br />
              Top reasons why developers prefer Monitrix over Datadog
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Monitrix is built from the ground up for OpenTelemetry. That means OTel-first docs,
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Monitrix provides both cloud & self-hosted versions. You can use the cloud,
                  enterprise self-host, or free, open-source community edition, depending on your
                  needs. Many of our users use open-source Monitrix in dev environments and Monitrix
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Monitrix provides 9x more value for your money than Datadog. Complex billing
                  practices, unpredictable pricing, and pricing that sometimes doesn't make sense
                  are common issues that Datadog users highlight. Monitrix offers simple usage-based
          ...
          <div className="space-y-16">
            ...
            <div>
                    ...
                    <tbody className="text-gray-300">
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          ...
                          with OpenTelemetry) with Monitrix.
                        </td>
                      </tr>
                      <tr className="transition-colors hover:bg-gray-800/50">
                        <td className="border-b border-gray-800/50 px-6 py-4">
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Leveraging OTel's trace context propagation & semantic conventions, Monitrix
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Monitrix uses the hostmetrics receiver in OTel Collector to collect all
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          ...
                          with out-of-the-box viz. in Monitrix for OTel data.
                        </td>
                      </tr>
                      <tr className="transition-colors hover:bg-gray-800/50">
                        <td className="border-b border-gray-800/50 px-6 py-4">
              ...
              <div className="mb-8">
                ...
                <p className="mb-6 text-[1.1rem] text-gray-300">
                  We built Monitrix on top of OpenTelemetry from Day 1, and we're at the right place
              ...
              <div>
                ...
                <p className="mb-6 text-[1.1rem] text-gray-300">
                  ...
                  the data is sent to, enables switching between signals easily. In Monitrix, the
              ...
              <div>
                ...
                <p className="mb-6 text-[1.1rem] text-gray-300">
                  At Monitrix, all metrics are treated equally and reasonably priced at $0.1 per
                  million samples.
                </p>
                ...
                <div className="mb-8 rounded-lg border border-gray-800 bg-gray-900/50 p-4">
                  <Link
                    ...
                    target="_blank"
                  >
                    Check Monitrix's Pricing Plans →
                  </Link>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="mb-6 text-[1.1rem] text-gray-300">
                ...
                interface, lots of users find Monitrix to be much easier to operate and monitor their
                  ...
                  <table className="m-0 w-full border-collapse text-left">
                    ...
                    <tbody className="text-gray-300">
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Monitrix simplifies tracking RED metrics for external calls - click on
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          If you want OTel based APM, then Monitrix is a clear choice.
                        </td>
                      </tr>
                      <tr className="transition-colors hover:bg-gray-800/50">
                        <td className="border-b border-gray-800/50 px-6 py-4">
              ...
              <div className="mb-8">
                ...
                <div className="mb-6">
                  ...
                  <p className="mt-2 text-sm text-gray-400">
                    Key operations shown for Cart Service in Monitrix
                  </p>
                </div>

                <p className="mb-6 text-[1.1rem] text-gray-300">
                  Service-level RED metrics in Monitrix are derived from a combination of service top
                  ...
                  <table className="m-0 w-full border-collapse text-left">
                    ...
                    <tbody className="text-gray-300">
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Under the hood, Monitrix uses ClickHouse(used by likes of Uber) - an
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          See timeseries plot of logs sent. In Monitrix you can apply different
                  ...
                  <table className="m-0 w-full border-collapse text-left">
                    ...
                    <tbody className="text-gray-300">
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Monitrix provides a powerful query builder which allows a list of
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          You can choose any arbitrary attribute to create aggregations in Monitrix.
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Root spans are the entry point for any trace. In Monitrix you can view them
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          Both Monitrix and Datadog shows related logs with a span. The UX might be
            ...
            <div>
              ...
              <p className="mb-6 text-[1.1rem] text-gray-300">
                ...
                <br /> <br />
                But if you're looking to use OpenTelemetry, Monitrix is a better choice. OpenTelemetry
                Collector has a{' '}
                <Link
                    ...
                    <tbody className="text-gray-300">
                      ...
                      <tr className="transition-colors hover:bg-gray-800/50">
                        ...
                        <td className="border-b border-gray-800/50 px-6 py-4">
                          ...
                          while in Monitrix you will have granular controls on what metrics you want
        ...
        <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          ...
          >
            <Link href="#value-for-money" className="flex items-center hover:text-gray-300">
              <LinkIcon className="absolute -left-8 h-6 w-6 text-blue-400 opacity-0 transition-opacity group-hover:opacity-100" />
              Monitrix is 9x More Value for Money than Datadog
            </Link>
          </h2>
          ...
          <p className="mb-8 text-[1.1rem] text-gray-300">
            ...
            APM hosts, 50 infra hosts, and 2500 GB logs data, Monitrix can provide up to 9x more value
            than Datadog. (
            <Link
              href="https://signoz.io/blog/pricing-comparison-signoz-vs-datadog-vs-newrelic-vs-grafana/"
              className="text-blue-400 hover:text-blue-300"
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="mb-6 text-[1.1rem] text-gray-300">
                ...
                52% of your bill for a large engineering team. Monitrix does not treat custom metrics
            ...
            <div>
              ...
              <p className="mt-4 text-[1.1rem] text-gray-300">
                Monitrix lets you collect infra metrics through the hostmetrics receiver in
          ...
          <div className="mt-12">
            <p className="mb-4 text-[1.1rem] italic text-gray-300">
              Listen to Shiv Ansal, CTO at Bands, explaining why he chose Monitrix over Datadog for
              his startup, Bands.
            </p>
            <div className="overflow-hidden rounded-lg">
              ...
              >
                Get Started with Monitrix for Free →
              </Link>
            </div>
          </div>
        </section>
            ...
            faqs={[
              {
                ...
                answer: (
                  <span>
                    ...
                    for Monitrix Cloud, you get 30 days of free trial with access to all features.
                  </span>
                ),
              },
              {
                question: 'How do I estimate my usage in Monitrix?',
                answer: (
                  <span>
                    You can use our{' '}
                    <Link
                    ...
                    to estimate your monthly bill with Monitrix.
                  </span>
                ),
              },
              {
                question: 'How is custom metric charged in Monitrix?',
                answer: (
                  <span>
                    All metrics are charged at the same price in Monitrix. We do not categorize any
                    metric as "custom" as is done by Datadog. You can estimate your metrics billing
                    in Monitrix with this{' '}
                    <Link
        ...
        <section className="mx-auto max-w-4xl rounded-xl bg-gradient-to-r from-blue-900/20 to-purple-900/20 px-4 py-12 sm:px-6">
          ...
          <div className="text-gray-300">
            <p className="mb-6 text-[1.1rem] text-gray-300">
              We provide support for migrating from Datadog to Monitrix if your monthly billing in
              Datadog is greater than 1000 USD. Request a migration from one of our experts and get
              started with Monitrix quickly.
            </p>
