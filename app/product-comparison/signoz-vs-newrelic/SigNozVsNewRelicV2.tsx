        ...
        <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
          ...
          >
            <Link href="#why-choose-signoz" className="flex items-center hover:text-gray-300">
              ...
              Why do Engineering Teams Choose Monitrix over New Relic?
            </Link>
          </h2>

          <div className="mb-8">
            <p className="text-lg text-gray-300">
              Monitrix is a great choice as a New Relic Alternative. We built Monitrix to address the
              ...
              <br />
              <br />
              Top reasons why developers prefer Monitrix over New Relic:
            </p>
          </div>
          ...
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  ...
                  OpenTelemetry, Monitrix is the best choice.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Monitrix uses ClickHouse as a datastore under the hood. ClickHouse is a columnar
                  ...
                  <br />
                  <br />
                  With Monitrix, you can quickly do complex aggregations on any attribute present in
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  ...
                  At Monitrix, we don't charge based on user seats.
                </p>
              </div>
            </div>
          </div>
