...
const COMPARISON_DATA = {
  ...
  MIGRATE: {
    TITLE: <>Migrate from New Relic to Monitrix with ease.</>,
    DESC: (
      <>
  ...
  REASONS: [
    {
      ...
      DESC: (
        <>
          ...
          more active. Using an open source standard like OpenTelemetry frees you from vendor
          lock-in. Monitrix is built to support OpenTelemetry from Day 1. New Relic treats OTel data
    ...
    },
    {
      ...
      DESC: (
        <>
          Monitrix uses ClickHouse - a fast open source distributed columnar database. Ingestion and
    ...
    },
    {
      ...
      DESC: (
        <>
          User-based pricing is outdated. You never know which engineer might need to access the
          monitoring tool for debugging. At Monitrix, we don’t charge based on user seats. New Relic’s
          user pricing can go up to $549/user. Even for teams with 10-15 devs, the cost becomes
          significant. At scale, the cost of adding users can go up to 66% of the total bill.{' '}
          <Link
    ...
    },
    {
      ...
      DESC: (
        <>
          For 20 APM hosts, 50 million indexed spans, 50 infra hosts, and 2500 GB logs data, SigNoz
          can save 67% of your New Relic bill.{' '}
          <Link
    ...
    },
    {
      ...
      DESC: (
        <>
          You can host Monitrix in your own cloud. We also provide managed services. It’s perfect for
          customers having data privacy and data governance requirements.
          <br />
          We have data centers in the EU, US, and India region to help you comply with data
          regulations.{' '}
  ...
  COMPARISON: {
    ...
    DATA: [
      ...
      },
      {
        ...
        otherExtraDetail: 'Treats Otel data differently than data from its own SDKs',
      },
      {
      ...
      },
      {
        ...
        otherExtraDetail: 'Goes up to $549 per user per month for enterprise users',
      },
      {
        sideHeader: 'Managed in your cloud options',
        isAvailableInSignoz: true,
        isAvailableInOther: false,
        signozExtraDetail: 'More suited if you have data privacy and data governance requirements',
  ...
  MIGRATION_SUPPORT: {
    ...
    DESC: (
      <>
        We provide support for migrating from New Relic to Monitrix.{' '}
        <Link href="/product-comparison/migrate-from-newrelic/" className="highlight">
          Request a migration support
        </Link>{' '}
        from one of our experts and get started with Monitrix quickly.
      </>
    ),
  },
}