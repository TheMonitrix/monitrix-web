              ...
              <div className="card-demo margin--md">
                <div className="card-dark h-[180px] rounded-md bg-signoz_slate-500">
                  ...
                  <div className="card__body">
                    <p className="text-sm">
                      Write to us at <a href="mailto:aurobindolife888@gmail.com">aurobindolife888@gmail.com</a> for
                      any queries
                    </p>
                  </div>
                ...
                <div className="card-dark h-[180px] rounded-md bg-signoz_slate-500">
                  ...
                  <div className="card__footer">
                    <Link
                      className="button button--secondary button--outline text-xs"
                      target="_blank"
                      href={'https://github.com/ezeslucky/monitrix.git/signoz/discussions'}
                    >
                      GitHub Discussions
                    </Link>
                  </div>
