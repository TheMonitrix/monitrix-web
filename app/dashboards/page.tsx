  ...
  return (
    <div className="bg-black-900 container mx-auto px-4 py-12">
      ...
      <div className="mb-8 flex items-center justify-between">
        ...
        <div>
          <a
            href="https://github.com/ezeslucky/monitrix.git/signoz/issues/new?assignees=&labels=dashboard-template&p[…]s=&template=request_dashboard.md&title=%5BDashboard+Request%5D+"
            target="_blank"
