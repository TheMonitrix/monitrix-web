...
const cardData = [
  {
    ...
    description: 'Monitrix is now SOC2 Type II and HIPAA compliant',
    url: '/blog/signoz-is-soc2-type2-and-hipaa-compliant/',
  },
  {
    title: 'Chat with Ankit, CTO of Monitrix',
    description: 'Get a sneak peek of the upcoming roadmap of Monitrix',
